...
def get_member(grd,num):
    ...
    grid1 = nmc_verification.nmc_vf_base.basicdata.grid(grid0.glon,grid0.glat,grid0.gtime,grid0.dtimes,grid0.levels)
...
def get_mean(grd,member_name):
    grid0 = nmc_verification.nmc_vf_base.basicdata.get_grid_of_data(grd)
    grid1 = nmc_verification.nmc_vf_base.basicdata.grid(grid0.glon,grid0.glat,grid0.gtime,grid0.dtimes,grid0.levels,members=[member_name])
