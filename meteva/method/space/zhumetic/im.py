...
def im(mat, xcol=None, yrow=None, xrange=None, yrange=None, unitname=None):
    ...
    xcol = range(0, mat.shape[1])
    yrow = range(0, mat.shape[0])
    ...
    unitname =  meteva.method.space.zhumetic.as_unitname(unitname)
    out = {'v': mat, 'dim': np.shape(mat), 'xrange': xrange, 'yrange': yrange,
