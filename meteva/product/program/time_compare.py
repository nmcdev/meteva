...
def ob_and_multi_time_fo(sta_ob_all,sta_fo_all,pic_path = None,max_dh = None,clev = None,cmap = None,plot_error = False,cmap_error= None):
    ...
    data_name = meteva.base.get_undim_data_names(sta_fo_all)[0]
    sta_ob_all1 = copy.deepcopy(sta_ob_all)
    meteva.base.set_stadata_names(sta_ob_all1,[data_name])
    sta_all = meteva.base.combine_join(sta_ob_all1, sta_fo_all)
    ...
    if pic_path is None:
        ...
        meteva.base.tool.path_tools.creat_path(pic_path)
...
def wind_ob_and_multi_time_fo(sta_ob_all,sta_fo_all,pic_path = None,max_dh = None,plot_error = True):
    ...
    data_names = meteva.base.get_stadata_names(sta_fo_all)
    #print(data_names)
    sta_ob_all1 = copy.deepcopy(sta_ob_all)
    #print(sta_ob_all1)
