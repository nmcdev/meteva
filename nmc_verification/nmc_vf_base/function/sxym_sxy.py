...
def mean_of_sta_ensemble(sta_ensemble):
    sta_mean = sta_ensemble[nmc_verification.nmc_vf_base.get_coord_names()]
...
def std_of_sta_ensemble(sta_ensemble):
    sta_std = sta_ensemble[nmc_verification.nmc_vf_base.get_coord_names()]
    sta_data = sta_ensemble[nmc_verification.nmc_vf_base.get_data_names(sta_ensemble)]
    value = sta_data.values
...
def var_of_sta_ensemble(sta_ensemble):
    sta_var = sta_ensemble[nmc_verification.nmc_vf_base.get_coord_names()]
    sta_data = sta_ensemble[nmc_verification.nmc_vf_base.get_data_names(sta_ensemble)]
    value = sta_data.values
...
def max_of_sta_ensemble(sta_ensemble):
    sta_max = sta_ensemble[nmc_verification.nmc_vf_base.get_coord_names()]
    sta_data = sta_ensemble[nmc_verification.nmc_vf_base.get_data_names(sta_ensemble)]
    value = sta_data.values
...
def min_fo_sta_ensemble(sta_ensemble):
    sta_min = sta_ensemble[nmc_verification.nmc_vf_base.get_coord_names()]
    sta_data = sta_ensemble[nmc_verification.nmc_vf_base.get_data_names(sta_ensemble)]
    value = sta_data.values
...
def get_one_element_by_name(sta_ensemble,name):
    column = nmc_verification.nmc_vf_base.get_coord_names()
    column.append(name)
...
def get_one_element_by_number(sta_ensemble,number):
    column = nmc_verification.nmc_vf_base.get_coord_names()
    data_names = nmc_verification.nmc_vf_base.get_data_names(sta_ensemble)
