...
def draw_veri_rain_24(grd_fo, sta_ob, filename=None):
    ...
    # 设置地图背景
    extendx = grid_fo.elon - grid_fo.slon
    extendy = grid_fo.elat - grid_fo.slat
    #rate = extendx/extendy
    #if(rate >7/4):
    #    extendx = extendy * 7/4
    #else:
    #    extendy = extendx/(7/4)
    map_extent = [grid_fo.slon, grid_fo.slon+extendx, grid_fo.slat, grid_fo.slat+ extendy]
