...
class veri_plot_set:
    ...
    def bar(self,veri_result):
        ...
        for para_dict in file_pare_list:
            veri_result_plot = veri_result[para_dict]
            ...
            for s in range(subplot_num):
                ...
                veri_result_subplot = veri_result_plot[dict()]
                ...
                for c in range(legend_num):
                    ...
                    veri_result_subplot = veri_result_plot[para_dict_subplot]
                    values = veri_result_subplot.values
                    axs[si,sj].bar(x,values,bar_width,color =  colors[c], label=plot_pare_dict[self.legend][c])
                axs[si,sj].legend()
            save_path = self.save_dir
            for key in para_dict.keys():
                save_path += key + "="+ para_dict[key] + "_"
            save_path += ".png"
